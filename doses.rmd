...
library(ggplot2)
ldh_activ<- ggplot(data = bal, aes(x = sample, y = ldh_activ)) +
  stat_summary(fun = "mean",geom = "bar", aes(fill = sample ), position = "dodge")+
...
library(ggplot2)
protein_conc<- ggplot(data = bal, aes(x = sample, y = protein_conc)) +
  stat_summary(fun = "mean",geom = "bar", aes(fill = sample ), position = "dodge")+
